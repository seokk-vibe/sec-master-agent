...
_SCENARIOS = [
    ...
    _scenario(3, "담보2부족 현황안내", "collateral_shortage", "담보 부족 현황 안내"),
    _scenario(4, "미수동결 현황안내", "receivable_freeze", "미수동결 현황 안내"),
    _scenario(5, "자동이체 오류현황", "auto_transfer_error", "자동이체 오류 조회"),
    _scenario(6, "신한플러스 등급 및 포인트 조회", "shinhan_plus_grade", "신한플러스 등급/포인트 조회"),
    _scenario(7, "이벤트 신청 및 당첨현황 안내", "event_status", "이벤트 신청/당첨 현황"),
    _scenario(8, "이체수수료 무료 쿠폰 조회", "transfer_fee_coupon", "수수료 무료 쿠폰 조회"),
    _scenario(9, "탑스클럽 등급 조회", "tops_club_grade", "탑스클럽 등급 조회"),
    _scenario(10, "중요알림", "important_notice", "중요 알림 조회"),
    _scenario(11, "입출금내역(계좌선택)", "deposit_withdrawal_history", "입출금 내역 조회"),
    _scenario(12, "증시일정", "market_schedule", "증시 일정 조회"),
    _scenario(13, "투자플러스(구 스톡마켓)", "investment_plus", "투자플러스 조회"),
    _scenario(14, "환율 조회", "exchange_rate", "환율 조회"),
    _scenario(15, "섹터정보 조회", "sector_info", "섹터 정보 조회"),
    _scenario(16, "유튜브 조회", "youtube_search", "유튜브 관련 조회"),
    _scenario(17, "지점찾기", "branch_locator", "지점 위치 조회"),
